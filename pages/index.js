    ...
    <div className={`w-full bg-gray-600 shadow`}>
      ...
      <div className={styles.container}>
        <Head>
          <title>
            {' '}
            Watch Movies Online™ - The Best Movies & Tv Show Platform HD{' '}
          </title>
          <link
            rel='sitemap'
          ...
          <meta
            property='og:title'
            content='Watch Movies Online™ - The Best Movies & Tv Show Platform HD'
          />
          <meta
          ...
          <meta name='application-name' content='Watch Movies Online™ - The Best Movies & Tv Show Platform HD' />
          <meta
          ...
          <div className='container mt-0 '>
            <Tabs>
              <TabList className={styles.tabList}>
                ...
                <Tab
                  className={`${styles.tab} ${styles.movies}`}
                  style={{
                    fontWeight: 'bold',
                    textShadow: '2px 5px 5px #000000'
                  }}
                ...
                <Tab
                  className={`${styles.tab} ${styles.tvshows}`}
                  style={{
                    fontWeight: 'bold',
                    textShadow: '2px 5px 5px #000000'
                  }}
              ...
              <TabPanel>
                <div
                  className={`row ${styles.movieList}`}
                ...
                >
                  ...
                  {movies.map((movie, index) => (
                    <div
                      key={index}
                      className={`col-md-3 col-sm-6 mb-3 ${styles.movieContainer}`}
                      style={{ position: 'relative' }}
                    >
                      <a href={movie['movie.watch']} className='w-img'>
                        <div
                          className={`image-container ${styles.moviePoster}`}
                        >
                          <img
                            src={movie.image}
                            alt={movie.title}
        ...
        `}</style> */}
              ...
              <TabPanel>
                ...
                >
                  {/* Dummy images for Movies */}
                  {movies
                    .filter(movie => movie.group === 'movies')
                    .map((movie, index) => (
                      <div
                        key={index}
                        className={`col-md-3 mb-3 ${styles.movieContainer}`}
                      >
                        <a href={movie['movie.watch']} className='w-img'>
                          <div
                            className={`image-container ${styles.moviePoster}`}
              ...
              <TabPanel>
                ...
                >
                  ...
                  {movies
                    .filter(movie => movie.group === 'tvshow')
                    .map((movie, index) => (
                      <div
                        key={index}
                        className={`col-md-3 mb-3 ${styles.movieContainer}`}
              ...
              <TabPanel>
                ...
                >
                  ...
                  {movies
                    .filter(movie => movie.group === 'adult')
                    .map((movie, index) => (
                      <div
                        key={index}
                        className={`col-md-3 mb-3 ${styles.movieContainer}`}
