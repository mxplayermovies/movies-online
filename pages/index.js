    ...
    "@graph": [
      {
        ...
        about: { "@id": "https://soap2dayhd.vercel.app/#organization" },
        primaryImageOfPage: { "@id": "https://soap2dayhd.vercel.app/#primaryimage" },
        image: { "@id": "https://soap2dayhd.vercel.app/#primaryimage" },
        ...
        breadcrumb: { "@id": "https://soap2dayhd.vercel.app/#breadcrumb" },
        inLanguage: "en-US",
        potentialAction: [
          { "@type": "ReadAction", target: ["https://soap2dayhd.vercel.app/"] },
        ],
      },
      {
        "@type": "ImageObject",
        inLanguage: "en-US",
        "@id": "https://soap2dayhd.vercel.app/#primaryimage",
      ...
      {
        "@type": "BreadcrumbList",
        "@id": "https://soap2dayhd.vercel.app/#breadcrumb",
        ...
        potentialAction: [
          {
            ...
            target: {
              "@type": "EntryPoint",
              urlTemplate: "https://soap2dayhd.vercel.app/?s={search_term_string}",
            },
            "query-input": {
  ...
  return (
    <>
      <Head>
        ...
        />
        <link rel="canonical" href="https://soap2dayhd.vercel.app/" />
        ...
        />
        <meta property="og:url" content="https://soap2dayhd.vercel.app" />
        <meta
      ...
      <div className={styles.title}>
        <div className="content">
          <h1 className="title px-0 bg-gradient-to-r from-amber-500 to-pink-500 bg-clip-text text-transparent text-2xl  font-bold mt-2">
            Soap2Day HD™ - Online. Stream. Download.
          </h1>
          ...
          <p className="description">
            Welcome to <strong>Soap2Day HD™</strong>, your premier destination
            ...
            <strong>Soap2Day HD™</strong> has something for everyone.
          </p>
          <p className="description">
            With a user-friendly interface and high-quality streaming,{" "}
            <strong>Soap2Day HD™</strong> makes it easy to find and enjoy your
          ...
          <p className="description">
            At <strong>Soap2Day HD™</strong>, we are committed to providing a
            ...
            dedicated binge-watcher, <strong>Soap2Day HD™</strong> is the
          ...
          <Link href="/home">
            <div className="cta-button">Enter Soap2Day HD™</div>
          </Link>
        </div>
      </div>
      {/* </div> */}
