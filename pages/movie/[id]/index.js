...
const MovieDetail = ({ movie }) => {
      ...
      const fetchComments = async () => {
        try {
          ...
          if (response.ok) {
            ...
            const filteredComments = commentsData.filter(comment => comment.movieId === movie.id);
  ...
  useEffect(() => {
    if (!playerReady || !movie) return

    const initializePlayer = () => {
      const videoIds = movie.videoitem
      const randomVideoId =
        ...
        interactionStatistic: [
          {
            ...
            interactionService: {
              '@type': 'WebSite',
              name: 'YouTube',
              '@id': movie.Youtubeid[0]
            },
            interactionType: 'https://schema.org/LikeAction',
            userInteractionCount: movie.userCount[0]
          }
        ]
      },
      {
        ...
        interactionStatistic: [
          {
            ...
            interactionService: {
              '@type': 'WebSite',
              name: 'YouTube',
              '@id': movie.Youtubeid[1]
            },
            interactionType: 'https://schema.org/LikeAction',
            userInteractionCount: movie.userCount[1]
          }
        ]
      },
      {
        ...
        interactionStatistic: [
          {
            ...
            interactionService: {
              '@type': 'WebSite',
              name: 'YouTube',
              '@id': movie.Youtubeid[2]
            },
            interactionType: 'https://schema.org/LikeAction',
            userInteractionCount: movie.userCount[2]
          }
        ]
      }
    ]
