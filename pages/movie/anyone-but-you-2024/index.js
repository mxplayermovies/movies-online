...
const anyone_but_you_2024 = ({ movie }) => {
  ...
  useEffect(() => {
    const fetchMovieDetails = async () => {
      try {
        ...
        const movie = data.find(movie => movie.id === 'INDEX71')
        setMovieData(movie)
      } catch (error) {
  ...
  return (
    <div>
      <Head>
        ...
        <meta
          property='og:image'
          content='https://res.cloudinary.com/dyx3mjea6/image/upload/v1711265109/Anyone_But_You_2023_uz4one.jpg'
        />
        ...
        <div className='container mt-0'>
          <Tabs>
            ...
            <TabPanel>
              ...
              >
                {/* <h2 style={{ color: "#15f4ee", textShadow: '3px 5px 5px #000' }}>Watch Server 1</h2> */}
                <span
                  style={{
                    color: '#15f4ee',
                    fontSize: '24px',
              ...
              {showPopup1 && (
                <div className='popup-overlay'>
                  <div className='popup'>
                    ...
                    <div className={Styles['iframe-container']}>
                      <iframe
                        className='  rounded-3xl  mr-8 flex  border-20 border-blue-600 p-2 '
        ...
        <div className='container mt-5'>
          <Tabs>
            ...
            <TabPanel>
              ...
              <div className='row mx-auto' style={{ marginTop: '5px' }}>
                <div className='button-container' style={{ marginTop: '10px' }}>
                  <a href={movieData.download1} target='_blank'>
            ...
            <TabPanel>
              ...
              <div className='row mx-auto' style={{ marginTop: '5px' }}>
                <div className='button-container' style={{ marginTop: '10px' }}>
                  <a href={movieData.download2} target='_blank'>
                    <button className='episode-button relative inline-flex items-center rounded-3xl my-5 justify-center p-0.5 mb-2 mr-2 overflow-hidden text-xl font-bold text-gray-900 group bg-gradient-to-br from-purple-600 to-blue-500 hover:bg-gradient-to-bl focus:ring-4 focus:outline-none focus:ring-blue-300 dark:focus:ring-blue-800 scale-100 hover:scale-110 cursor-pointer px-5 py-2.5 transition-all ease-in duration-75 bg-white dark:bg-gray-900 group-hover:bg-opacity-0'>
                      <span
                        style={{
                          color: '#0efa06',
            ...
            <TabPanel>
              ...
              <div className='row mx-auto' style={{ marginTop: '5px' }}>
                <div className='button-container' style={{ marginTop: '10px' }}>
                  <a href={movieData.download3} target='_blank'>
                    <button className='episode-button relative inline-flex items-center rounded-3xl my-5 justify-center p-0.5 mb-2 mr-2 overflow-hidden text-xl font-bold text-gray-900 group bg-gradient-to-br from-purple-600 to-blue-500 hover:bg-gradient-to-bl focus:ring-4 focus:outline-none focus:ring-blue-300 dark:focus:ring-blue-800 scale-100 hover:scale-110 cursor-pointer px-5 py-2.5 transition-all ease-in duration-75 bg-white dark:bg-gray-900 group-hover:bg-opacity-0'>
                      <span
                        style={{
                          color: '#f80303',
