...
const fetchmoviesData = async () => {
  const response = await fetch("https://soap2dayhd.vercel.app/moviesfull.json");
...
export default function MovieDetail({ movie }) {
  ...
  const fetchData = async () => {
    try {
      const response = await fetch(
        "https://soap2dayhd.vercel.app/moviesfull.json"
      );
  ...
  const webSiteSchema = JSON.stringify({
    ...
    potentialAction: {
      "@type": "SearchAction",
      target: "https://soap2dayhd.vercel.app/search?q={search_term_string}",
        ...
        {isTVShow && (
          <>
            ...
            <p className="text-lg text-yellow-500 mt-4">
              ...
              <strong> Soap2Day HD™</strong>, you can stream{" "}
            ...
            <p className="text-lg text-yellow-500 mt-4">
              ...
              <strong>Soap2Day HD™</strong> ensures that you won't miss a single
              moment of the action, drama, or comedy that makes this TV series a
              must-watch. With high-quality streaming and user-friendly
              navigation, <strong>Soap2Day HD™</strong> provides everything you
            ...
            <p className="text-lg text-yellow-500 mt-4">
              ...
              <strong>{movie.title}</strong> on <strong>Soap2Day HD™</strong> is
              ...
              <strong>Soap2Day HD™</strong>, your favorite TV series is just a
              click away.
            </p>
          </>
        )}
        ...
        {!isTVShow && !isAdult && (
          <>
            ...
            <p className="text-lg text-yellow-500 mt-4">
              ...
              <strong>{movie.title}</strong>. At <strong>Soap2Day HD™</strong>,
            ...
            <p className="text-lg text-yellow-500 mt-4">
              Streaming <strong>{movie.title}</strong> on{" "}
              <strong>Soap2Day HD™</strong> provides you with a user-friendly
            ...
            <p className="text-lg text-yellow-500 mt-4">
              ...
              <strong>Soap2Day HD™</strong>. Our platform ensures your privacy
              and security while you enjoy the content you love. Start streaming{" "}
              <strong>{movie.title}</strong> today and discover why{" "}
              <strong>Soap2Day HD™</strong> is the trusted choice for adult
              content.
            </p>
          </>
        )}
        ...
        {isAdult && (
          <>
            ...
            <p className="text-lg text-yellow-500 mt-4">
              ...
              available to stream right here. At <strong>Soap2Day HD™</strong>,
            ...
            <p className="text-lg text-yellow-500 mt-4">
              Streaming <strong>{movie.title}</strong> on{" "}
              <strong>Soap2Day HD™</strong> guarantees a seamless viewing
            ...
            <p className="text-lg text-yellow-500 mt-4">
              ...
              <strong>Soap2Day HD™</strong>, your entertainment is just a click
              away.
            </p>
          </>
        )}
