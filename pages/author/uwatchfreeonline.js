...
export default function WatchMoviesOnline ({ movie }) {
    ...
    const handleSearch = (event) => {
        ...
        if (searchTermLower.includes('tv show')) {
            searchURL = `https://www.google.com/search?q=site:https://uwatchfreeonline.vercel.app/tvshow/${encodeURIComponent(searchTermLower)}-2024`;
        } else {
            searchURL = `https://www.google.com/search?q=site:https://uwatchfreeonline.vercel.app/movie/${encodeURIComponent(searchTermLower)}-2024`;
        }
                    ...
                    dangerouslySetInnerHTML={{
                        __html: `{
                            ...
                            "@graph": [
                                ...
                                {
                                    "@type": "ProfilePage",
                                    "@id": "https://uwatchfreeonline.vercel.app/author/watchmoviesonline/#webpage",
