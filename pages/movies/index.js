...
const moviesSchema = JSON.stringify({
  ...
  "@graph": [
    {
      "@type": "CollectionPage",
      "@id": "https://soap2dayhd.vercel.app/movies/",
      url: "https://soap2dayhd.vercel.app/movies/",
      name: "Movies Section - Soap2Day HD™",
      isPartOf: { "@id": "https://soap2dayhd.vercel.app/#website" },
      primaryImageOfPage: {
        "@id": "https://soap2dayhd.vercel.app/movies/#primaryimage",
      },
      image: { "@id": "https://soap2dayhd.vercel.app/movies/#primaryimage" },
      thumbnailUrl: "https://soap2dayhd.vercel.app/og_image.jpg",
      breadcrumb: {
        "@id": "https://soap2dayhd.vercel.app/movies/#breadcrumb",
      },
      inLanguage: "en-US",
    },
    {
...
const HomePage = ({ categorizedItems }) => {
  ...
  return (
    <>
      <Head>
        <title>Soap2Day HD™ - Movies Page.</title>
        <meta
          name="description"
        ...
        <link rel="canonical" href="https://soap2dayhd.vercel.app/movies" />
