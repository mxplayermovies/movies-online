...
const tvshowDetail = ({ tvshow }) => {
  ...
  const rankMathSchema = JSON.stringify({
    ...
    '@graph': [
      ...
      {
        '@type': 'Person',
        '@id': 'https://uwatchfreeonline.vercel.app/author/watchtvshowsonline/',
        name: 'Dr Trailer',
        url: 'https://uwatchfreeonline.vercel.app/author/watchtvshowsonline/',
        image: {
          '@type': 'ImageObject',
      ...
      },
      {
        ...
        author: {
          '@id':
            'https://uwatchfreeonline.vercel.app/author/watchtvshowsonline/'
        },
        publisher: {
          '@id': 'https://gravatar.com/drtrailer2022/#person'
        },
