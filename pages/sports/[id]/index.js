...
const sportsDetail = ({ sports }) => {
  ...
  const uwatchfreeSchema = JSON.stringify([
    {
      ...
      "image": ["https://uwatchfreeonline.vercel.appwp-content/uploads/2023/05/favicon.ico"],
      "logo": {
        "@type": "ImageObject",
        "url": "https://uwatchfreeonline.vercel.applogo.png",
        "width": 280,
        "height": 80
      }
    },
    {
      ...
      "potentialAction": {
        "@type": "SearchAction",
        "target": "https://uwatchfreeonline.vercel.appsearch?q={search_term_string}",
  ...
  //     {
  //       '@type': 'Person',
  //       '@id': 'https://uwatchfreeonline.vercel.appauthor/watchsportssonline/',
  //       name: 'Dr Trailer',
  //       url: 'https://uwatchfreeonline.vercel.appauthor/watchsportssonline/',
  //       image: {
  //         '@type': 'ImageObject',
  ...
  //       author: {
  //         '@id':
  //           'https://uwatchfreeonline.vercel.appauthor/watchsportssonline/'
  //       },
  //       publisher: {
  //         '@id': 'https://gravatar.com/drtrailer2022/#person'
  //       },
